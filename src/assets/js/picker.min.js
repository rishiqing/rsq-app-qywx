 ...
 */
!function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.weui2 = t() : e.weui2 = t()
} (window,
function() {
    return function(e) {
        function t(i) {
	...
	*/
    ...
    default.fn.scroll = function(e) {
        ...
        default.extend({
            ...
            p = h.items.map(function(e) {
                return '<div class="weui-picker__item_p weui-picker__item _item' + (e.disabled ? " weui-picker__item_disabled": "") + '">' + ("object" == ("undefined" == typeof e ? "undefined": o(e)) ? e.label: e) + "</div>"
            }).join(""),
            v = (0, a.
        default)(this);
    ...
    function(e, t) {
        e.exports = '<div class="<%= className %>"> <div class=weui-mask></div> <div class="weui-picker _picker2"> <div class="weui-picker__hd _title"> <a href=javascript:; data-action=cancel class="weui-picker__action _cancel">取消</a> <span class="weui-picker__action _time">设置时间</span> <a href=javascript:; data-action=select class=weui-picker__action id=weui-picker-confirm>确定</a> </div> <div class=_chose><div class="_tt _c" id=_tl><div class="_ctitle _left">开始</div><span id=startTime class=_s-time></span></div><i class="icon2-arrow-right-small arrow b-ab"></i><div class=_tt id=_tr><div class="_ctitle _right">结束</div><span id=endTime class=_s-time></span></div></div><div class="weui-picker__bd _mb"></div> </div> </div> '
    },
    function(e, t) {
        e.exports = "<div class=weui-picker__group> <div class=weui-picker__mask></div> <div class='weui-picker__indicator _pick'></div> <div class=weui-picker__content></div> </div>"
    }])
});